                    ...
                    Box {
                        FloatingActionButtonMenu(
                            ...
                            FloatingActionButtonMenuItem(
                                ...
                                icon = { Icon(Icons.Default.Add, stringResource(Res.string.new_transaction)) },
                                onClick = {
                                    expanded = false
                            ...
                            templates.forEach { template ->
                                FloatingActionButtonMenuItem(
                                    ...
                                    icon = { Icon(Icons.AutoMirrored.Filled.NoteAdd, stringResource(Res.string.add_transaction)) },
                                    onClick = {
                                        expanded = false
